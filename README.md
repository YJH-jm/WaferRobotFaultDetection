...
### 3. 프로젝트 목적 :
- 반도체 이송 로봇을 operation 하여 얻은 데이터를 이용하여 로봇 고장을 미리 예측할 수 있는 알고리즘 설계
...
- 초음파 센서와 카메라 데이터를 이용하여 의도하지 않은 비정상적인 데이터를 제외한 결과- 하나의 데이터 세트는 x, y, z 축 3개로 구성되며 각 축의 데이터는 968개
